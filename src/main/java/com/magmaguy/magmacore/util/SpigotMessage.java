...
public class SpigotMessage {
    ...
    public TextComponent simpleMessage(String message) {
        return new TextComponent(ChatColorConverter.convert(message));
    }

    public TextComponent hoverMessage(String message, String hoverMessage) {
    ...
    public TextComponent commandHoverMessage(String message, String hoverMessage, String commandString) {
    ...
    public TextComponent hoverLinkMessage(String message, String hoverMessage, String link) {
